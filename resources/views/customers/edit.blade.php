            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}"  enctype="multipart/form-data">
                        ...
                        @method('PUT')
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end" value="">{{ __('Name') }}</label>
                        ...
                        <div class="row mb-3">
                            <label for="Profile_Pricture" class="col-md-4 col-form-label text-md-end">{{ __('Profile_Pricture') }}</label>

                            <div class="col-md-6">
                                <input id="Profile_Pricture" type="file" class="form-control @error('Profile_Pricture') is-invalid @enderror" name="Profile_Picture" required autocomplete="new-profile_pricture">
